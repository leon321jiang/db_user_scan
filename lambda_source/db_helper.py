def get_current_users_and_roles(db_host, db_name, db_user, db_password, db_engine):
    '''
    ...
    if db_engine == 'mysql':
        ...
        return get_current_users_and_roles_mysql(db_host, db_name, db_user, db_password)
    elif db_engine == 'postgres':
        from db_helper_postgres import get_current_users_and_roles_postgres
        return get_current_users_and_roles_postgres(db_host, db_name, db_user, db_password)
    elif db_engine == 'oracle':
        from db_helper_oracle import get_current_users_and_roles_oracle
        return get_current_users_and_roles_oracle(db_host, db_name, db_user, db_password)
    else:
